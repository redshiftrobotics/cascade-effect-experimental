...
public class WheeledTankDrive extends OpMode

{
...

    {
        ...
        v_motor_left_drive = hardwareMap.dcMotor.get ("left_drive_1");
        v_motor_left_drive = hardwareMap.dcMotor.get ("left_drive_2");
        v_motor_left_drive = hardwareMap.dcMotor.get ("left_drive_3");

        v_motor_right_drive = hardwareMap.dcMotor.get ("right_drive_1");
        v_motor_right_drive = hardwareMap.dcMotor.get ("right_drive_2");
        v_motor_right_drive = hardwareMap.dcMotor.get ("right_drive_3");
